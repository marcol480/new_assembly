...
int main(){ // ---  MAIN
    ...
    /* $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$ */
        ...
        if(PRINT_CONFIG){
            ...
            sprintf(file_namext,"numerics/freq%0.1lf/config_cells_%dcells_%dbarcodes_noise-var%0.3lf.dat", freq, N_CELL, N_BARCODE, LAMBDA_CELL);
            xt=fopen(file_namext, "w") ;

            sprintf(file_namext_b,"numerics/freq%0.1lf/config_barcodes_%dcells_%dbarcodes_noise-var%0.3lf.dat",  freq, N_CELL, N_BARCODE, LAMBDA_CELL);
            xt_b=fopen(file_namext_b, "w") ;
        }

        sprintf(file_name,"numerics/freq%0.1lf/events_%dcells_%dbarcodes_noise-var%0.3lf_run%d_sin.dat",  freq, N_CELL, N_BARCODE, LAMBDA_CELL, a);
    ...
    randomize_pos( &PosForce_Barcode[0], 3+a, N_BARCODE);
